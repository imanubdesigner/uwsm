#!/bin/bash
output_file="$HOME/.config/manu/current/theme/vscode_colors.json"
...
if [[ -f "$HOME/.config/manu/current/theme/vscode.json" ]]; then
    exit 0
fi
...
install_location="$install_path/themes/base16/manu.json"
