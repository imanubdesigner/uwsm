...
run_command "pacman -S --noconfirm hyprland hyprland-qtutils wtype wf-recorder satty jq grim slurp wl-clipboard wl-clip-persist libnotify cliphist waybar hyprpicker hypridle hyprlock uwsm xdg-desktop-portal-gtk xdg-desktop-portal-hyprland qt5-remoteobjects hyprland-qtutils qt5-wayland qt6-wayland hyprsunset hyprpolkitagent dunst" "Install complete Hyprland ecosystem (core, session manager, wayland support, addons)" "yes"
