...
run_command "pacman -S --needed --noconfirm hyprland hyprland-guiutils satty jq grim slurp wl-clipboard libnotify waybar hyprpicker hypridle hyprlock uwsm libnewt xdg-desktop-portal-gtk xdg-desktop-portal-hyprland qt5-wayland qt6-wayland hyprsunset polkit-gnome mako" "Install complete Hyprland ecosystem (core, session manager, wayland support, addons)" "yes"
