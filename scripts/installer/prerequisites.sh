...
run_command "reflector --age 24 --protocol https --latest 20 --sort rate --save /etc/pacman.d/mirrorlist" "Update Pacman mirrorlist with fresh, fast mirrors" "no"
