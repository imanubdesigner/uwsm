...
# -------------------- Drivers --------------------
run_command "pacman -S --noconfirm linux-headers nvidia-open-dkms nvidia-utils libva libva-utils lib32-nvidia-utils libva-nvidia-driver egl-wayland" "Install Nvidia Open DKMS" "yes"
...
run_command "pacman -S --noconfirm gtk-engine-murrine gnome-themes-extra nautilus nautilus-python gtk4 glib2 gobject-introspection gum ufw jdk21-openjdk inotify-tools sassc meson wget cargo swww python-pyquery luarocks curl spotify-launcher nodejs npm tree-sitter tree-sitter-cli cmake ninja bat bat-extras yazi chromium obsidian neovim discord mpv yt-dlp cava evince zsh zsh-completions wiremix zoxide fzf eza ghostty imagemagick starship nano fastfetch ripgrep rofi rofi-emoji btop pacman-contrib tar p7zip unrar unzip libgsf libgepub libwebp libopenraw gvfs gvfs-mtp udisks2 xdg-user-dirs ffmpegthumbnailer ffmpeg poppler-glib librsvg qt6-imageformats qt5-imageformats" "Install complete application suite (browsers, media, development, system tools)" "yes"
