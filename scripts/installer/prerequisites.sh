...
run_command "pacman -S --needed --noconfirm alsa-plugins alsa-utils android-tools bat bat-extras btop cargo cava chromium cmake curl discord evince eza fastfetch fcitx5 fcitx5-gtk fcitx5-qt ffmpeg ffmpegthumbnailer fzf ghostty glib2 gnome-themes-extra gobject-introspection gtk4 glow gum gvfs gvfs-mtp gvfs-nfs gvfs-smb gst-plugin-pipewire imagemagick imv inotify-tools lazygit libgepub libgsf libopenraw librsvg libwebp luarocks meson mlocate mpv nano nautilus nautilus-python neovim ninja nodejs npm noto-fonts noto-fonts-emoji noto-fonts-extra obsidian pacman-contrib pamixer p7zip pipewire pipewire-alsa pipewire-jack pipewire-pulse poppler-glib python-pyquery qt5-imageformats qt6-imageformats ripgrep sassc snap-pac spotify-launcher starship sushi swayosd swww tar tree-sitter tree-sitter-cli ttf-jetbrains-mono-nerd udisks2 ufw unrar unzip wget wiremix wireplumber woff2-font-awesome xdg-user-dirs xsel yazi yt-dlp zsh zsh-completions zoxide" "Install complete application suite (browsers, media, development, system tools)" "yes"
