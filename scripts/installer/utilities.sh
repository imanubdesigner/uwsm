...
# -------------------- Configuration Files --------------------
run_command "\
cp -r $BASE_DIR/configs/waybar /home/$SUDO_USER/.config/ && \
cp -r $BASE_DIR/configs/tofi /home/$SUDO_USER/.config/ && \
cp -r $BASE_DIR/configs/waypaper /home/$SUDO_USER/.config/ && \
...
chown -R $SUDO_USER:$SUDO_USER /home/$SUDO_USER/.config/tofi && \
chown -R $SUDO_USER:$SUDO_USER /home/$SUDO_USER/.config/waypaper && \
chown -R $SUDO_USER:$SUDO_USER /home/$SUDO_USER/.local/share/applications" \
  "Copy all configuration files and desktop entries" "yes" "no"
